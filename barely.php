...
<header class="header">
  ...
  <div class="container my-5">
    <h2 class="text-center my-3">Chemical Details for Barley </h2>
    <div class="row">
      <!-- Chemical 1 -->
      <div class="col-md-6 col-lg-4 mb-4">
        <div class="card chemical-card">
          <div class="card-body">
            ...
            <p><strong>Safety Instructions:</strong> Wear gloves and goggles; avoid inhalation</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-6 col-lg-4">
        <div class="card chemical-card">
          <div class="card-body">
            <h4 class="card-title">Fenpropidin</h4>
            <p><strong>Quantity:</strong> 400 ml/acre</p>
            <p><strong>Result Rating:</strong> <span class="rating">★★★★☆</span></p>
            <p><strong>Time to Use:</strong> Tillering Stage</p>
            <p><strong>How to Spray:</strong> Mix with 200 liters of water and spray thoroughly</p>
            <p><strong>Safety Instructions:</strong> Use a mask; avoid contact with skin</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-6 col-lg-4">
        <div class="card chemical-card">
          <div class="card-body">
            <h4 class="card-title">Prothioconazole</h4>
            <p><strong>Quantity:</strong> 250 ml/acre</p>
            <p><strong>Result Rating:</strong> <span class="rating">★★★★★</span></p>
            <p><strong>Time to Use:</strong> Stem Elongation</p>
            <p><strong>How to Spray:</strong> Dilute with 150 liters of water and spray evenly</p>
            <p><strong>Safety Instructions:</strong> Wear protective clothing; avoid inhalation</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-6 col-lg-4">
        <div class="card chemical-card mb-4">
          <div class="card-body">
            ...
            <p><strong>Result Rating:</strong> <span class="rating">★★★☆☆</span></p>
            <p><strong>Time to Use:</strong> Flag Leaf Emergence</p>
            <p><strong>How to Spray:</strong> Mix with 200 liters of water and apply evenly</p>
            <p><strong>Safety Instructions:</strong> Use protective eyewear; wash hands after handling</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-6 col-lg-4">
        <div class="card chemical-card">
          <div class="card-body">
            <h4 class="card-title">Cyproconazole</h4>
            <p><strong>Quantity:</strong> 300 ml/acre</p>
            <p><strong>Result Rating:</strong> <span class="rating">★★★★☆</span></p>
            <p><strong>Time to Use:</strong> Heading Stage</p>
            <p><strong>How to Spray:</strong> Mix with 100 liters of water and spray uniformly</p>
            <p><strong>Safety Instructions:</strong> Avoid inhalation; keep away from children</p>
          </div>
        </div>
      </div>
    </div>
