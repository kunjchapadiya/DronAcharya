...
<header class="header">
  ...
  <div class="container my-5">
    <h2 class="text-center my-3">Chemical Details for Coffee</h2>
    <div class="row">
      <!-- Chemical 1 -->
      <div class="col-md-6 col-lg-4 mb-4">
        <div class="card chemical-card">
          <div class="card-body">
            <h4 class="card-title">Copper Oxychloride</h4>
            <p><strong>Quantity:</strong> 3 kg/acre</p>
            <p><strong>Result Rating:</strong> <span class="rating">★★★★☆</span></p>
            <p><strong>Time to Use:</strong> Pre-Monsoon</p>
            <p><strong>How to Spray:</strong> Mix with 200 liters of water; spray evenly over the foliage</p>
            <p><strong>Safety Instructions:</strong> Wear gloves and goggles; avoid inhaling the spray</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-6 col-lg-4">
        <div class="card chemical-card">
          <div class="card-body">
            <h4 class="card-title">Hexaconazole</h4>
            <p><strong>Quantity:</strong> 500 ml/acre</p>
            <p><strong>Result Rating:</strong> <span class="rating">★★★☆☆</span></p>
            <p><strong>Time to Use:</strong> Flowering Stage</p>
            <p><strong>How to Spray:</strong> Dilute in 200 liters of water and apply uniformly</p>
            <p><strong>Safety Instructions:</strong> Use a mask and protective clothing; avoid contact with skin</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-6 col-lg-4">
        <div class="card chemical-card">
          <div class="card-body">
            <h4 class="card-title">Chlorpyrifos</h4>
            <p><strong>Quantity:</strong> 1 liter/acre</p>
            <p><strong>Result Rating:</strong> <span class="rating">★★★★★</span></p>
            <p><strong>Time to Use:</strong> Pest Outbreak</p>
            <p><strong>How to Spray:</strong> Mix with 200 liters of water and spray on affected areas</p>
            <p><strong>Safety Instructions:</strong> Avoid spraying during windy conditions; keep away from children</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-6 col-lg-4">
        <div class="card chemical-card mb-4">
          <div class="card-body">
            ...
            <p><strong>Quantity:</strong> 250 ml/acre</p>
            <p><strong>Result Rating:</strong> <span class="rating">★★★★☆</span></p>
            <p><strong>Time to Use:</strong> Post-Monsoon</p>
            <p><strong>How to Spray:</strong> Mix with 150 liters of water and apply uniformly on leaves</p>
            <p><strong>Safety Instructions:</strong> Wear a face shield; avoid direct inhalation</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-6 col-lg-4">
        <div class="card chemical-card">
          <div class="card-body">
            <h4 class="card-title">Bordeaux Mixture</h4>
            <p><strong>Quantity:</strong> 5 kg/acre</p>
            <p><strong>Result Rating:</strong> <span class="rating">★★★☆☆</span></p>
            <p><strong>Time to Use:</strong> Disease Management</p>
            <p><strong>How to Spray:</strong> Mix thoroughly with water; spray on stems and leaves</p>
            <p><strong>Safety Instructions:</strong> Use protective clothing; wash hands and face after use</p>
          </div>
        </div>
      </div>
    </div>
