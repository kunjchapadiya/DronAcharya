...
<header class="header">
  ...
  <div class="container my-5">
    <h2 class="text-center my-3">Chemical Details</h2>
    <div class="row">
      <!-- Chemical 1 -->
      <div class="col-md-6 col-lg-4 mb-4">
        <div class="card chemical-card">
          <div class="card-body">
            <h4 class="card-title">Azoxystrobin</h4>
            <p><strong>Quantity:</strong> 2 liters/acre</p>
            <p><strong>Result Rating:</strong> <span class="rating">★★★★☆</span></p>
            <p><strong>Time to Use:</strong> Early Growth</p>
            <p><strong>How to Spray:</strong> Use with a sprayer; mix with 20 liters of water</p>
      ...
      <div class="col-md-6 col-lg-4">
        <div class="card chemical-card">
          <div class="card-body">
            ...
            <p><strong>Result Rating:</strong> <span class="rating">★★★☆☆</span></p>
            <p><strong>Time to Use:</strong> Mid Growth</p>
            <p><strong>How to Spray:</strong> Mix with 200 liters of water; spray evenly</p>
            <p><strong>Safety Instructions:</strong> Use a mask; keep away from children</p>
          </div>
        </div>
      </div>
      <br>
      ...
      <div class="col-md-6 col-lg-4">
        <div class="card chemical-card">
          ...
          <div class="card-body">
            <h4 class="card-title">Fenitrothion</h4>
            <p><strong>Quantity:</strong> 1 kg/acre</p>
            <p><strong>Result Rating:</strong> <span class="rating">★★★★★</span></p>
            <p><strong>Time to Use:</strong> Flowering</p>
            <p><strong>How to Spray:</strong> Spray using a mist blower; dilute with water</p>
            <p><strong>Safety Instructions:</strong> Wash hands after use; avoid skin contact</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-6 col-lg-4">
        <div class="card chemical-card mb-4">
          ...
          <div class="card-body">
            ...
            <p><strong>Quantity:</strong> 800 g/acre</p>
            <p><strong>Result Rating:</strong> <span class="rating">★★★☆☆</span></p>
            <p><strong>Time to Use:</strong> Mature</p>
            <p><strong>How to Spray:</strong> Mix thoroughly with water; apply uniformly</p>
            <p><strong>Safety Instructions:</strong> Use protective clothing; avoid contact with eyes</p>
          </div>
        </div>
      </div>
