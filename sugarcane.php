...
<header class="header">
  ...
  <div class="container my-5">
    <h2 class="text-center my-3">Chemical Details for Sugarcane</h2>
    <div class="row">
      <!-- Chemical 1 -->
      <div class="col-md-6 col-lg-4 mb-4">
        <div class="card chemical-card">
          <div class="card-body">
            ...
            <p><strong>Time to Use:</strong> Early Growth (Weed Control)</p>
            <p><strong>How to Spray:</strong> Mix with 200 liters of water and spray uniformly</p>
            <p><strong>Safety Instructions:</strong> Wear gloves and a mask; avoid direct contact with skin</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-6 col-lg-4">
        <div class="card chemical-card">
          <div class="card-body">
            ...
            <p><strong>Result Rating:</strong> <span class="rating">★★★☆☆</span></p>
            <p><strong>Time to Use:</strong> Mid Growth (Pest Control)</p>
            <p><strong>How to Spray:</strong> Mix with 150 liters of water and spray evenly</p>
            <p><strong>Safety Instructions:</strong> Use protective eyewear; wash hands after application</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-6 col-lg-4">
        <div class="card chemical-card">
          <div class="card-body">
            ...
            <p><strong>Result Rating:</strong> <span class="rating">★★★★★</span></p>
            <p><strong>Time to Use:</strong> Vegetative Stage (Pest Control)</p>
            <p><strong>How to Spray:</strong> Dilute with 200 liters of water and spray thoroughly</p>
            <p><strong>Safety Instructions:</strong> Avoid inhalation; keep away from food items</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-6 col-lg-4">
        <div class="card chemical-card mb-4">
          <div class="card-body">
            ...
            <p><strong>Result Rating:</strong> <span class="rating">★★★★☆</span></p>
            <p><strong>Time to Use:</strong> Pre-Harvest (Disease Control)</p>
            <p><strong>How to Spray:</strong> Mix with 150 liters of water and apply uniformly</p>
            <p><strong>Safety Instructions:</strong> Use gloves and goggles; avoid skin contact</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-6 col-lg-4">
        <div class="card chemical-card">
          <div class="card-body">
            <h4 class="card-title">Metribuzin</h4>
            <p><strong>Quantity:</strong> 1 kg/acre</p>
            <p><strong>Result Rating:</strong> <span class="rating">★★★☆☆</span></p>
            <p><strong>Time to Use:</strong> Early Growth (Weed Control)</p>
            <p><strong>How to Spray:</strong> Mix with 250 liters of water and apply evenly</p>
            <p><strong>Safety Instructions:</strong> Avoid inhalation; store in a cool, dry place</p>
          </div>
        </div>
      </div>
    </div>
