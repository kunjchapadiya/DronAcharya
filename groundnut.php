...
<header class="header">
  ...
  <div class="container my-5">
    <h2 class="text-center my-3">Chemical Details for Groundnut </h2>
    <div class="row">
      <!-- Chemical 1 -->
      <div class="col-md-6 col-lg-4 mb-4">
        <div class="card chemical-card">
          <div class="card-body">
            <h4 class="card-title">Mancozeb</h4>
            <p><strong>Quantity:</strong> 1 kg/acre</p>
            <p><strong>Result Rating:</strong> <span class="rating">★★★★☆</span></p>
            <p><strong>Time to Use:</strong> Early Vegetative Stage</p>
            <p><strong>How to Spray:</strong> Mix with 200 liters of water and spray uniformly</p>
            <p><strong>Safety Instructions:</strong> Wear gloves and a face mask; avoid inhalation</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-6 col-lg-4">
        <div class="card chemical-card">
          <div class="card-body">
            ...
            <p><strong>Result Rating:</strong> <span class="rating">★★★☆☆</span></p>
            <p><strong>Time to Use:</strong> Pegging Stage</p>
            <p><strong>How to Spray:</strong> Mix with 150 liters of water and apply during the evening</p>
            <p><strong>Safety Instructions:</strong> Avoid contact with skin; wash thoroughly after use</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-6 col-lg-4">
        <div class="card chemical-card">
          <div class="card-body">
            <h4 class="card-title">Imidacloprid</h4>
            <p><strong>Quantity:</strong> 50 ml/acre</p>
            <p><strong>Result Rating:</strong> <span class="rating">★★★★★</span></p>
            <p><strong>Time to Use:</strong> Flowering Stage</p>
            <p><strong>How to Spray:</strong> Dilute with 100 liters of water and spray evenly</p>
            <p><strong>Safety Instructions:</strong> Use protective gear; avoid direct inhalation</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-6 col-lg-4">
        <div class="card chemical-card mb-4">
          <div class="card-body">
            ...
            <p><strong>Result Rating:</strong> <span class="rating">★★★★☆</span></p>
            <p><strong>Time to Use:</strong> Pod Formation Stage</p>
            <p><strong>How to Spray:</strong> Mix with 200 liters of water; apply uniformly</p>
            <p><strong>Safety Instructions:</strong> Avoid spraying near water bodies; use a mask</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-6 col-lg-4">
        <div class="card chemical-card">
          <div class="card-body">
            ...
            <p><strong>Result Rating:</strong> <span class="rating">★★★☆☆</span></p>
            <p><strong>Time to Use:</strong> Maturity Stage</p>
            <p><strong>How to Spray:</strong> Mix with 150 liters of water and spray evenly</p>
            <p><strong>Safety Instructions:</strong> Avoid contact with eyes; store in a cool, dry place</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
          ...
          <p><a href="#" class="text-white">Book a Service</a></p>
          <p><a href="#" class="text-white">About us</a></p>
          <p><a href="#" class="text-white">Chemicals</a></p>
        </div>
