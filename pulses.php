...
<header class="header">
  ...
  <div class="container my-5">
    <h2 class="text-center my-3">Chemical Details for Pulses</h2>
    <div class="row">
      <!-- Chemical 1 -->
      <div class="col-md-6 col-lg-4 mb-4">
        <div class="card chemical-card">
          <div class="card-body">
            <h4 class="card-title">Chlorothalonil</h4>
            <p><strong>Quantity:</strong> 400 g/acre</p>
            <p><strong>Result Rating:</strong> <span class="rating">★★★★☆</span></p>
            <p><strong>Time to Use:</strong> Vegetative Stage</p>
            <p><strong>How to Spray:</strong> Mix with 150 liters of water and spray uniformly</p>
            <p><strong>Safety Instructions:</strong> Wear gloves and avoid inhaling the spray</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-6 col-lg-4">
        <div class="card chemical-card">
          <div class="card-body">
            <h4 class="card-title">Dimethoate</h4>
            <p><strong>Quantity:</strong> 500 ml/acre</p>
            <p><strong>Result Rating:</strong> <span class="rating">★★★★☆</span></p>
            <p><strong>Time to Use:</strong> Flowering Stage</p>
            <p><strong>How to Spray:</strong> Mix with 200 liters of water and apply early morning</p>
            <p><strong>Safety Instructions:</strong> Use a mask; wash hands thoroughly after use</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-6 col-lg-4">
        <div class="card chemical-card">
          <div class="card-body">
            <h4 class="card-title">Carbendazim</h4>
            <p><strong>Quantity:</strong> 1 liter/acre</p>
            <p><strong>Result Rating:</strong> <span class="rating">★★★★★</span></p>
            <p><strong>Time to Use:</strong> Pod Formation</p>
            <p><strong>How to Spray:</strong> Dilute with 100 liters of water and spray thoroughly</p>
            <p><strong>Safety Instructions:</strong> Avoid contact with skin; wash with soap after application</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-6 col-lg-4">
        <div class="card chemical-card mb-4">
          <div class="card-body">
            ...
            <p><strong>Quantity:</strong> 100 ml/acre</p>
            <p><strong>Result Rating:</strong> <span class="rating">★★★★☆</span></p>
            <p><strong>Time to Use:</strong> Early Growth</p>
            <p><strong>How to Spray:</strong> Mix with 150 liters of water and spray evenly</p>
            <p><strong>Safety Instructions:</strong> Use protective clothing; avoid inhalation</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-6 col-lg-4">
        <div class="card chemical-card">
          <div class="card-body">
            <h4 class="card-title">Thiophanate-methyl</h4>
            <p><strong>Quantity:</strong> 300 g/acre</p>
            <p><strong>Result Rating:</strong> <span class="rating">★★★☆☆</span></p>
            <p><strong>Time to Use:</strong> Grain Development</p>
            <p><strong>How to Spray:</strong> Mix thoroughly with water and apply uniformly</p>
            <p><strong>Safety Instructions:</strong> Avoid skin contact; wash exposed areas thoroughly</p>
          </div>
        </div>
      </div>
    </div>
