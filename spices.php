...
<header class="header">
  ...
  <div class="container my-5">
    <h2 class="text-center my-3">Chemical Details for Spices</h2>
    <div class="row">
      <!-- Chemical 1 -->
      <div class="col-md-6 col-lg-4 mb-4">
        <div class="card chemical-card">
          <div class="card-body">
            ...
            <p><strong>Quantity:</strong> 2 kg/acre</p>
            <p><strong>Result Rating:</strong> <span class="rating">★★★★☆</span></p>
            <p><strong>Time to Use:</strong> Early Growth</p>
            <p><strong>How to Spray:</strong> Mix with 200 liters of water and apply uniformly</p>
      ...
      <div class="col-md-6 col-lg-4">
        <div class="card chemical-card">
          <div class="card-body">
            <h4 class="card-title">Difenoconazole</h4>
            <p><strong>Quantity:</strong> 300 ml/acre</p>
            <p><strong>Result Rating:</strong> <span class="rating">★★★☆☆</span></p>
            <p><strong>Time to Use:</strong> Vegetative Stage</p>
            <p><strong>How to Spray:</strong> Mix with 100 liters of water and spray in the evening</p>
      ...
      <div class="col-md-6 col-lg-4">
        <div class="card chemical-card">
          <div class="card-body">
            ...
            <p><strong>How to Spray:</strong> Mix with 150 liters of water; spray evenly</p>
            <p><strong>Safety Instructions:</strong> Avoid direct contact with skin; use goggles</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-6 col-lg-4">
        <div class="card chemical-card mb-4">
          <div class="card-body">
            <h4 class="card-title">Emamectin Benzoate</h4>
            <p><strong>Quantity:</strong> 200 g/acre</p>
            <p><strong>Result Rating:</strong> <span class="rating">★★★★☆</span></p>
            <p><strong>Time to Use:</strong> Pest Infestation</p>
            <p><strong>How to Spray:</strong> Dilute in 150 liters of water and spray directly on affected plants</p>
            <p><strong>Safety Instructions:</strong> Wear a mask; avoid inhalation</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-6 col-lg-4">
        <div class="card chemical-card">
          <div class="card-body">
            ...
            <p><strong>Quantity:</strong> 2 kg/acre</p>
            <p><strong>Result Rating:</strong> <span class="rating">★★★☆☆</span></p>
            <p><strong>Time to Use:</strong> Disease Outbreak</p>
            <p><strong>How to Spray:</strong> Mix with 200 liters of water and spray evenly</p>
            <p><strong>Safety Instructions:</strong> Use protective gloves; keep away from water sources</p>
          </div>
        </div>
      </div>
    </div>
