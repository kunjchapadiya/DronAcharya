...
<header class="header">
  ...
  <div class="container my-5">
    <h2 class="text-center my-3">Chemical Details for Cotton</h2>
    <div class="row">
      <!-- Chemical 1 -->
      <div class="col-md-6 col-lg-4 mb-4">
        <div class="card chemical-card">
          <div class="card-body">
            ...
            <p><strong>How to Spray:</strong> Mix with 200 liters of water and spray evenly</p>
            <p><strong>Safety Instructions:</strong> Use gloves and a face mask; avoid inhalation</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-6 col-lg-4">
        <div class="card chemical-card">
          <div class="card-body">
            ...
            <p><strong>How to Spray:</strong> Dilute with 150 liters of water and spray during the morning</p>
            <p><strong>Safety Instructions:</strong> Use protective goggles; avoid contact with skin</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-6 col-lg-4">
        <div class="card chemical-card">
          <div class="card-body">
            <h4 class="card-title">Spinosad</h4>
            <p><strong>Quantity:</strong> 75 ml/acre</p>
            <p><strong>Result Rating:</strong> <span class="rating">★★★★★</span></p>
            <p><strong>Time to Use:</strong> Flowering Stage</p>
            <p><strong>How to Spray:</strong> Mix with 120 liters of water and apply uniformly</p>
            <p><strong>Safety Instructions:</strong> Avoid ingestion; keep away from children</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-6 col-lg-4">
        <div class="card chemical-card mb-4">
          <div class="card-body">
            <h4 class="card-title">Fenvalerate</h4>
            <p><strong>Quantity:</strong> 200 ml/acre</p>
            <p><strong>Result Rating:</strong> <span class="rating">★★★★☆</span></p>
            <p><strong>Time to Use:</strong> Boll Development</p>
            <p><strong>How to Spray:</strong> Mix with 150 liters of water and spray during the evening</p>
            <p><strong>Safety Instructions:</strong> Use protective clothing; wash hands after handling</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-6 col-lg-4">
        <div class="card chemical-card">
          <div class="card-body">
            ...
            <p><strong>Quantity:</strong> 200 ml/acre</p>
            <p><strong>Result Rating:</strong> <span class="rating">★★★☆☆</span></p>
            <p><strong>Time to Use:</strong> Late Growth</p>
            <p><strong>How to Spray:</strong> Mix with 100 liters of water and spray evenly</p>
            <p><strong>Safety Instructions:</strong> Avoid inhalation; use in well-ventilated areas</p>
          </div>
        </div>
      </div>
    </div>
